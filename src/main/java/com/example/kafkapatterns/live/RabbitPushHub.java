...
/**
 * Server-Sent Events hub for RabbitMQ-style fanout → User B (auto push).
 */
@Component
public class RabbitPushHub {

    private static final Logger log = LoggerFactory.getLogger(RabbitPushHub.class);
